...
echo "════════════════════════════════════════════════════════════"
echo "  MGPU-SM-NSYS — softmax_mgpu under nsys (4× H100)"
...
TRACE_BASE=${LOGDIR}/softmax_mgpu_nsys_${SLURM_JOB_ID}
...
echo ">>> Running nsys profile softmax_mgpu_align --calls 100 --n-gpus 4 ..."
