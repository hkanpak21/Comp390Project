...
NTL::RR GetInvApproxError(int d, NTL::RR t, vector<NTL::RR> &X, vector<NTL::RR> &Y, long num);
...
NTL::RR eval(long deg, vector<NTL::RR> &coeff, NTL::RR val, int type, NTL::RR scale);
void showgraph(ofstream &out, NTL::RR *coeff, long deg, NTL::RR start, NTL::RR end, NTL::RR sc, int type, NTL::RR scale);
void showgraph(ofstream &out, vector<NTL::RR> coeff, long deg, NTL::RR start, NTL::RR end, NTL::RR sc, int type, NTL::RR scale);
...
NTL::RR invexpmaxerr(long deg, NTL::RR expy, vector<NTL::RR> &X, vector<NTL::RR> &Y, long num);
NTL::RR getmaxerr(NTL::RR (*func)(NTL::RR), vector<NTL::RR> &coeff, long deg, NTL::RR start, NTL::RR end, int type, NTL::RR scale, long prec, long num, bool is_opt_sampling);
NTL::RR find_extreme(NTL::RR (*func)(NTL::RR), Point *&ext, int &ext_count, vector<NTL::RR> coeff, long deg, NTL::RR start, NTL::RR end, long prec, NTL::RR scan, int type, NTL::RR scale, bool is_opt_sampling);
}  // namespace minicomp
